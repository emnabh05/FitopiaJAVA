...
public class MainController {
    ...
    @FXML
    private void openSupplementBackEnd(ActionEvent event) {
        try {
            SceneNavigator.navigate(event, SceneNavigator.FITNESS_BACK_VIEW, SceneNavigator.BACK_END_VIEW);
        } catch (IOException exception) {
            showAlert(Alert.AlertType.ERROR, "Navigation", "Impossible d'ouvrir le back supplement.");
        }
    }

    @FXML
    private void openSupplementFrontEnd(ActionEvent event) {
        try {
