...
class DmConversation
{
    ...
    #[ORM\OneToMany(mappedBy: 'conversation', targetEntity: DmParticipant::class, cascade: ['persist', 'remove'])]
    private Collection $participants;

    #[ORM\OneToMany(mappedBy: 'conversation', targetEntity: DmMessage::class, cascade: ['persist', 'remove'])]
