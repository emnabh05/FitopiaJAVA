...
public final class SceneNavigator {
    ...
    public static final ViewState START_VIEW = new ViewState("/SupplementCatalogShowcase.fxml", "Supplement Front End");
    ...
    public static final ViewState FITNESS_FRONT_VIEW = new ViewState("/frontregime.fxml", "Fitness Front End");
    public static final ViewState FITNESS_BACK_VIEW = new ViewState("/backrepas.fxml", "Fitness Back End");
